...
export default function Offer() {
  ...
  const cards = [
    { id: "01", label: "Offering to the Sangha for Healing and Blessings" },
    { id: "02", label: "Donation Ceremony" },
    { id: "03", label: "Offering to the Sangha for Healing and Blessings" },
    { id: "04", label: "Donation Ceremony" },
    // Add more if needed
  ];
